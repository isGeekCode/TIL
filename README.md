...
- [UIApplication - 탭바컨트롤러 / 네비게이션컨트롤러 / 기본적인 ios 앱의 계층구조](Mobile-IOS/UIApplication_AppDelegate_AppLifeCycle.md)
- [UIApplication_AppDelegate - userNotificationCenter](Mobile-IOS/UIApplication_AppDelegate_userNotificationCenter.md)
- [UIApplication - AppDelegate - App's Status / App's Life-Cycle](Mobile-IOS/UIApplication_StatusCycle_of_App.md)
