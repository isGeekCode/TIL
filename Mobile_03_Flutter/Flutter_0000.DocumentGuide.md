...
### 로드맵
|TIL|BLOG | 카테고리 | 단계 | 소단계 | 학습 포인트| 실습 예제| 관련 위젯 / 키워드|
|:--:|:--:|:--:|:----:|:---:|:---:|:---:|:---:|
...
|❌|❌| 🔌 | 15   | 15.11  | 결제 연동 (WebView 스킴 처리)       | 웹에서 결제 링크(intent:// 등) 감지 후 외부 앱 연동 또는 전용 페이지 이동 처리 | shouldOverrideUrlLoading, intent scheme, 결제 URL |
